...
Перебор гиперпараметров и отдельные ablation-эксперименты запланированы в следующем этапе.
...
- **Интерпретируемость:** вывод feature importance ещё не реализован. В следующем этапе планирую добавить важности признаков для RandomForest/GradientBoosting и сравнить их с логикой генерации данных.
...
- Основное ограничение - синтетическая природа данных. Хотя они и созданы с использованием реальных данных и схожей с реальностью логикой, сейчас модели по сути смогли обучиться на формуле генерации данных и предсказывать их. Тем не менее, при обучении их на собранных реальных данных, они покажут достаточно хороший результат